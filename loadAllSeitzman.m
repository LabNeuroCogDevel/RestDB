...
if 1
    dbcn = sqlite('rest.db');
    tbl = get_rest(dbcn,sprintf('rest.study like "%s" and rest.preproc like "%s" and rest.atlas like "%s" and dx like "control"', study, pipeline, atlas));
...
%%
[networkIDs, allnets] = loadParcLabels_Seitzman300;
meanr = nanmean(r,3);
